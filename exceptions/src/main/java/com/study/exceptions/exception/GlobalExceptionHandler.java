package com.study.exceptions.exception;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleMethodArgumentTypeMismatch(final MethodArgumentTypeMismatchException ex,
        ...
        final String message = "The request path parameter should be of type: " + ex.getRequiredType().getSimpleName();

        ResponseException exception = new ResponseException(HttpStatus.BAD_REQUEST, HttpStatus.BAD_REQUEST.value(),
                message);
    ...
    protected ResponseEntity<Object> handleMissingServletRequestParameter(MissingServletRequestParameterException ex,
        ...
        final String message = "The request parameter: " + ex.getParameterName() + ", of type: " + ex.getParameterType()
                + ", is missing";
    ...
    protected ResponseEntity<Object> handleHttpRequestMethodNotSupported(HttpRequestMethodNotSupportedException ex,
        ...
        Set<String> info = ex.getSupportedHttpMethods().stream().map(method -> "Method supported: " + method.name())
    ...
    protected ResponseEntity<Object> handleNotFound(final RuntimeException ex, final WebRequest request) {
        ...
        ResponseException exception = new ResponseException(HttpStatus.NOT_FOUND, HttpStatus.NOT_FOUND.value(), message);
        return handleExceptionInternal(ex, exception, new HttpHeaders(), exception.getStatus(), request);
    }
    ...
    protected ResponseEntity<Object> handleConflict(final DataIntegrityViolationException ex,
        ...
        ResponseException exception = new ResponseException(HttpStatus.CONFLICT, HttpStatus.CONFLICT.value(), message,
                info);
